...
var myCareer = {
  ...
  tools: {Multi module, Coroutine flow,BloC, Provider, Firebase, Background ervices,
  Map location, Dagger-Hilt, Media3(media-player-service)},
  architecture: {"MVVM", "Clean-Architecture"},
  projects:[  
  {"Clone app of 100haryt.com" : "https://drive.google.com/file/d/1K_kTXSAVcrpuCOAmrO5YB1SsQSGrkic-/view?usp=sharing" },
